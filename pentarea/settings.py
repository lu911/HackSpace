...
SECRET_KEY = 'p@=fl^^n&amp;sznzfipz5w1(u%muq)-1(4e_y^*g5$d=ewp!h#4@u'
...
LOGGING = {
    ...
    'handlers': {
        'file_userlogins': {
            ...
            'formatter': 'verbose',
            'filename': os.path.join(VENV_ROOT, 'log', 'userlogins.log')
        },
        ...
        'file_usersaves': {
            ...
            'class': 'logging.FileHandler',
            'formatter': 'verbose',
            'filename': os.path.join(VENV_ROOT, 'log', 'usersaves.log')
        },
        'mail_admins': {
            'level': 'ERROR',
